...
> **⚠️ IMPORTANT NOTE:** The cafe listings currently shown on the site are example/demonstration data created while we build this platform. These are not real cafes accepting Nexa at this time. Real cafe listings will be added as the platform launches.
